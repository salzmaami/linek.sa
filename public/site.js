...
const placeModes = {
  single: {
    title: 'صفحة تليق بمكانك',
    description: 'صورك، وصفك، موقعك، السعر، وسياسات الحجز في رابط واضح يبني الثقة من أول نظرة.',
    name: 'شاليه سُكون',
    prompt: 'اختر تاريخك المناسب',
    action: 'عرض الأيام المتاحة'
  },
  multi: {
    title: 'كل أماكنك في منصة واحدة',
    description: 'اعرض شاليهاتك أو شققك اليومية معًا، ولكل مكان صوره وتقويمه وسعره، وأدرها كلها من لوحة واحدة.',
    name: 'مجموعة سُكون · ٣ أماكن',
    prompt: 'اختر المكان المناسب لك',
...
function buildLeadMessage(data) {
  return [
    ...
    '',
    'أرغب بتجربة 14 يوم وترتيب رابط الحجز.'
  ].join('\n');
}
